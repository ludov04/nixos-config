...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Ludovic Vannoorenberghe"
    user-mail-address "ludovic.v@me.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/ludov/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/ludov/bin" "/profile/bin" "/Users/ludov/.npm-packages/bin" "/Users/ludov/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
